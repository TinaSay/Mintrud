...
namespace app\modules\anticorruption\controllers\backend;

use app\modules\anticorruption\models\Anticorruption;
use app\modules\anticorruption\models\search\AnticorruptionSearch;
...
class AnticorruptionController extends Controller
{
    ...
    {
        $searchModel = new AnticorruptionSearch();
