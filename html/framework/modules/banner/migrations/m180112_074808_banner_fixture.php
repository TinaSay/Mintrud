...
/**
 * Class m180112_074808_banner_fixture
 */
class m180112_074808_banner_fixture extends Migration
{
    /**
     * @inheritdoc
     */
    public function safeUp()
    {
        ...
        $rows = [
            'Ключевые государственные информационные ресурсы' => [
                ['title' => 'Сайт Президента Российской Федерации', 'url' => 'http://kremlin.ru/'],
                ['title' => 'Правительство Российской Федерации', 'url' => 'http://government.ru/'],
                ...
                ['title' => 'Верховный Суд Российской Федераций', 'url' => 'http://www.supcourt.ru/'],
            ...
            'Информационные порталы и информация Минтруда России' => [
                ...
                ['title' => 'Форма для подачи запросов на разъяснение информации о разработке и реализации планов мероприятий («дорожных карт»)', 'url' => '/docs/mintrud/payment/14/'],
                ...
                ['title' => 'Анкетирование по вопросам проведения специальной оценки условий труда', 'url' => 'http://demo.rosmintrud.ru/labour/safety/0/'],
                ...
                ['title' => 'Общенациональная информационная кампания «Россия — без жестокости к детям»', 'url' => 'http://www.ya-roditel.ru/'],
            ...
            'Cервисы и автоматизированные информационные системы' => [
                ...
                ['title' => 'Реестр системы независимой оценки квалификаций', 'url' => 'https://nok-nark.ru/'],
            ...
            'Неправительственные организации' => [
                ...
                ['title' => 'Всероссийское общество слепых', 'url' => 'http://www.vos.org.ru/'],
                ...
                ['title' => 'Общероссийская общественная организация инвалидов войны в Афганистане и военной травмы – «Инвалиды войны»', 'url' => 'http://www.oooiva.ru/'],
            ...
            'Мероприятия и конкурсы' => [
                ...
                ['title' => 'Всероссийский конкурс профессионального мастерства «Лучший по профессии»', 'url' => '/events/560/'],
