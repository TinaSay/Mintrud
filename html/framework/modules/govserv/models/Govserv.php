...
namespace app\modules\govserv\models;

use app\modules\auth\models\Auth;
use Yii;

/**
 * This is the model class for table "{{%govserv}}".
 *
 * @property integer $id
 ...
 */
class Govserv extends \yii\db\ActiveRecord
{
    /**
     * @return array
     */
    ...
    /**
     * @inheritdoc
     * @return \app\modules\govserv\models\query\GovservQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\modules\govserv\models\query\GovservQuery(get_called_class());
    }
