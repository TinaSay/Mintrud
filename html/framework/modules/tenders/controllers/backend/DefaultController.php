...
namespace app\modules\tenders\controllers\backend;

use app\modules\system\components\backend\Controller;
use app\modules\tenders\models\Tender;
use app\modules\tenders\models\TenderSearch;
use Yii;
use yii\filters\VerbFilter;
use yii\web\NotFoundHttpException;

/**
 * DefaultController implements the CRUD actions for Tender model.
 */
