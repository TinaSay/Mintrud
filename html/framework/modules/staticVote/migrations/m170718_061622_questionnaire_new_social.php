...
class m170718_061622_questionnaire_new_social extends Migration
{
            ...
            [
                ...
                'questions' => [
                    ...
                    [
                        ...
                        'input' => StaticVoteQuestion::INPUT_TYPE_TEXT,
                        'child' => 'СТАЛ БЫ ФЕДЕРАЛЬНЫЙ «МАТЕРИНСКИЙ (СЕМЕЙНЫЙ) КАПИТАЛ» ДЛЯ ВАС БОЛЕЕ ЗНАЧИМЫМ, ЕСЛИ БЫ ЕГО МОЖНО БЫЛО ИСПОЛЬЗОВАТЬ НЕ ТОЛЬКО НА ТЕ ЦЕЛИ, КОТОРЫЕ СЕЙЧАС ПРЕДУСМОТРЕНЫ?_1',
                    ],
                    [
                    ...
                    [
                        ...
                        'input' => StaticVoteQuestion::INPUT_TYPE_TEXT,
                        'child' => 'СТАЛ БЫ РЕГИОНАЛЬНЫЙ «МАТЕРИНСКИЙ (СЕМЕЙНЫЙ) КАПИТАЛ» ДЛЯ ВАС БОЛЕЕ ЗНАЧИМЫМ, ЕСЛИ БЫ ЕГО МОЖНО БЫЛО ИСПОЛЬЗОВАТЬ НЕ ТОЛЬКО НА ТЕ ЦЕЛИ, КОТОРЫЕ СЕЙЧАС ПРЕДУСМОТРЕНЫ?_1',
                    ],
                    [
