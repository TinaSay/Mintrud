...
class m170725_050234_static_vote_social_chidren_fix3 extends Migration
{
    public function safeUp()
    {
        $this->addColumn('{{%static_vote_question}}', 'max_answers',
            $this->smallInteger()->notNull()->defaultValue(0)->after('min_answers')
        );
        ...
        $list = [
            [
                ...
                'questions' => [
                    ...
                    [
                        'title' => 'Напишите Ваше предложение',
                        'input' => StaticVoteQuestion::INPUT_TYPE_TEXT,
                    ...
                    [
                        'title' => 'Повышение компенсации части родительской платы за содержание детей в дошкольных организациях до 60% – на второго и до 100% – на третьего и последующих детей',
                        'answers' => [
                            1 => 'Да',
                            'Нет',
                            'Затрудняюсь ответить',
                    ...
                    [
                        'title' => 'ОБЕСПЕЧЕНИЕ РЕАЛЬНОЙ ВОЗМОЖНОСТИ ДЛЯ ВАС (ВАШЕЙ ЖЕНЫ/ВАШЕГО МУЖА) ИМЕТЬ ГИБКИЙ ГРАФИК РАБОТЫ, НЕПОЛНЫЙ РАБОЧИЙ ДЕНЬ (НЕДЕЛЮ), ПОСМЕННУЮ ИЛИ ДИСТАНЦИОННУЮ РАБОТУ (НА ДОМУ)',
                        'answers' => [
                            1 => 'Да',
                            'Нет',
                            'Затрудняюсь ответить',
                    ...
                    [
                        ...
                        'answers' => [
                            ...
                            'высшее профессиональное (в том числе незаконченное высшее)',
                        ],
                        'input' => StaticVoteQuestion::INPUT_TYPE_RADIO,
                        'child' => 'ОБЩИЕ СВЕДЕНИЯ О РЕСПОНДЕНТЕ',
                    ],
    ...
    public function safeDown()
    {
        ...
        $this->dropColumn('{{%static_vote_question}}', 'max_answers');

        echo "m170720_071952_questionnaire_new_social_fix - reverted.\n";
